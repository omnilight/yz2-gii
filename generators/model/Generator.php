...
class Generator extends \yii\gii\Generator
{
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            ...
            [['generateRelations', 'generateLabelsFromComments', 'prepareForBackend', 'useTablePrefix', 'useSchemaName', 'generateQuery'], 'boolean'],
            [['enableI18N'], 'boolean'],
     ...
     * @return array
     */
    public function getImplementInterfaces()
    {
        $interfaces = [];
        if ($this->prepareForBackend) {
